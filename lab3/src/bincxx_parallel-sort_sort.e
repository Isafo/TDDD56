...
void* parallel_merge_sort(void* args)
{
 ...
 if(args_t->depth > 0)
 {
  ...
  pthread_create(&d_thread, __null, parallel_merge_sort, (void*)&args1);
...
# 295 "sort.cpp"
...

 {
  ...
  pthread_create(&thread[i], __null, parallel_merge_sort, (void*)&t_args[i]);
 }
